...
pegasus-kickstart  -n findrange -N ID0000002 -R condorpool  -s f.c1=f.c1 -L blackdiamond -T 2020-07-10T21:45:00+00:00 /home/scitech/pegasus/dist/pegasus-5.0.0dev/bin/pegasus-keg -a findrange -T 3 -i f.b1 -o f.c1
job_ec=$?
