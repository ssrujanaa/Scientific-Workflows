...
pegasus-kickstart  -n findrange -N ID0000003 -R condorpool  -s f.c2=f.c2 -L blackdiamond -T 2020-07-10T21:45:00+00:00 /home/scitech/pegasus/dist/pegasus-5.0.0dev/bin/pegasus-keg -a findrange -T 3 -i f.b2 -o f.c2
job_ec=$?
