...
pegasus-kickstart  -n preprocess -N ID0000001 -R condorpool  -s f.b2=f.b2 -s f.b1=f.b1 -L blackdiamond -T 2020-07-10T21:45:00+00:00 /home/scitech/pegasus/dist/pegasus-5.0.0dev/bin/pegasus-keg -a preprocess -T 3 -i f.a -o f.b1 f.b2
job_ec=$?
