...
pegasus-kickstart  -n analyze -N ID0000004 -R condorpool  -s f.d=f.d -L blackdiamond -T 2020-07-10T21:45:00+00:00 /home/scitech/pegasus/dist/pegasus-5.0.0dev/bin/pegasus-keg -a analyze -T 3 -i f.c1 f.c2 -o f.d
job_ec=$?
