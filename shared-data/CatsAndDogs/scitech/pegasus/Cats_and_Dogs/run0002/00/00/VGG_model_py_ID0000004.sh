...
VGG_model_py:testing.pkl:validation.pkl:training.pkl
eof
...
pegasus-kickstart  -n VGG_model.py -N ID0000004 -R condorpool  -s model.h5.tar.gz=model.h5.tar.gz -L Cats_and_Dogs -T 2020-08-07T19:04:51+00:00 ./VGG_model_py 
job_ec=$?
