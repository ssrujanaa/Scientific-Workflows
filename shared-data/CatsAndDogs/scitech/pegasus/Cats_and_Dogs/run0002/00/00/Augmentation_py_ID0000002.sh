...
labels.txt:resized_images.txt:Augmentation_py
eof
...
pegasus-kickstart  -n Augmentation.py -N ID0000002 -R condorpool  -s aug_labels.txt=aug_labels.txt -s augmentation.txt=augmentation.txt -L Cats_and_Dogs -T 2020-07-30T15:21:16+00:00 ./Augmentation_py 
job_ec=$?
