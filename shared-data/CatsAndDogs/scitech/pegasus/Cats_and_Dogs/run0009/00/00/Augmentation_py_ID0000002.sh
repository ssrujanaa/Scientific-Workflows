...
labels.txt:resized_Cat0.jpg:resized_images.txt:Augmentation_py
eof
...
pegasus-kickstart  -n Augmentation.py -N ID0000002 -R condorpool  -s aug_labels.txt=aug_labels.txt -s Aug_resized_Cat0_0.jpg=Aug_resized_Cat0_0.jpg -s augmentation.txt=augmentation.txt -L Cats_and_Dogs -T 2020-08-03T18:11:41+00:00 ./Augmentation_py resized_Cat0.jpg
job_ec=$?
