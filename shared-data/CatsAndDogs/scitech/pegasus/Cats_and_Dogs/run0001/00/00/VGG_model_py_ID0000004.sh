...
pegasus-kickstart  -n VGG_model.py -N ID0000004 -R condorpool  -s checkpoint_file.hdf5=checkpoint_file.hdf5 -s model_history_log.csv=model_history_log.csv -s model.h5=model.h5 -L Cats_and_Dogs -T 2020-10-01T09:36:39+00:00 ./VGG_model_py 
job_ec=$?
