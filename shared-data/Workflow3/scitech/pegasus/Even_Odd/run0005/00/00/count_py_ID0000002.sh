...
pegasus-kickstart  -n count.py -N ID0000002 -R condorpool  -s even_count.txt=even_count.txt -L Even_Odd -T 2020-07-13T20:05:12+00:00 ./count_py even.txt even_count.txt
job_ec=$?
