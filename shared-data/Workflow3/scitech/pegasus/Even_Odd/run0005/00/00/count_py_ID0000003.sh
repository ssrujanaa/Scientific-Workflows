...
pegasus-kickstart  -n count.py -N ID0000003 -R condorpool  -s odd_count.txt=odd_count.txt -L Even_Odd -T 2020-07-13T20:05:12+00:00 ./count_py odd.txt odd_count.txt
job_ec=$?
