...
pegasus-kickstart  -n VGG_model.py -N ID0000004 -R condorpool  -s model.h5=model.h5 -L Cats_and_Dogs -T 2020-09-24T16:19:11+00:00 ./VGG_model_py 
job_ec=$?
