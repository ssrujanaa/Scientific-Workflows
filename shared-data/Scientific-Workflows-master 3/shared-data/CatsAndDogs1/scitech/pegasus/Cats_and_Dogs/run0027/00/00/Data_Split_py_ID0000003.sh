...
pegasus-kickstart  -n Data_Split.py -N ID0000003 -R condorpool  -s testing.pkl=testing.pkl -s validation.pkl=validation.pkl -s training.pkl=training.pkl -L Cats_and_Dogs -T 2020-09-24T18:45:02+00:00 ./Data_Split_py 
job_ec=$?
