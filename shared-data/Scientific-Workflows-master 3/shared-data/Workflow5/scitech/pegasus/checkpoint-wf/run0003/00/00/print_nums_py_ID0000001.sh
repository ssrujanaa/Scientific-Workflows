...
pegasus-kickstart  -n print_nums.py -N ID0000001 -o output.txt -R condorpool  -s output.txt=output.txt -s saved_stated.txt=saved_stated.txt -L checkpoint-wf -T 2020-07-20T17:56:06+00:00 -k 60 -K 30 ./print_nums_py 180
job_ec=$?
