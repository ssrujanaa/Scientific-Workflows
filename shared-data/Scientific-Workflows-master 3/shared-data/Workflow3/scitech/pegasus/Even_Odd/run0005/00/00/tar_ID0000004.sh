...
pegasus-kickstart  -n tar -N ID0000004 -R condorpool  -s results.tar.gz=results.tar.gz -L Even_Odd -T 2020-07-13T20:05:12+00:00 /bin/tar -cvzf results.tar.gz even_count.txt odd_count.txt
job_ec=$?
