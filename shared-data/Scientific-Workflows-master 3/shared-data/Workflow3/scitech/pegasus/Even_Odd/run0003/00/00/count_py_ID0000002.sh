...
pegasus-kickstart  -n count.py -N ID0000002 -R condorpool  -s even_count.txt=even_count.txt -L Even_Odd -T 2020-07-13T19:51:21+00:00 ./count_py even_nums.txt even_count.txt
job_ec=$?
