...
pegasus-kickstart  -n separate.py -N ID0000001 -R condorpool  -s even_nums.txt=even_nums.txt -s odd_nums.txt=odd_nums.txt -L Even_Odd -T 2020-07-13T19:51:21+00:00 ./separate_py 
job_ec=$?
