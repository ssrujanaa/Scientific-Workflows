...
pegasus-kickstart  -n checkpoint_program.py -N ID0000001 -o output.txt -R condorpool  -s output.txt=output.txt -s saved_state.txt=saved_state.txt -L checkpoint-wf -T 2020-07-20T17:16:45+00:00 -k 60 -K 30 ./checkpoint_program_py 180
job_ec=$?
