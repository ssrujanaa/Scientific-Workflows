...
pegasus-kickstart  -n increment.py -N ID0000001 -o backup.txt -R condorpool  -s backup.txt=backup.txt -L Increment -T 2020-07-12T06:09:09+00:00 ./increment_py input.txt backup.txt
job_ec=$?
