...
pegasus-kickstart  -n print_nums1.py -N ID0000001 -o output.txt -R condorpool  -s saved_stated.txt=saved_stated.txt -s output.txt=output.txt -L checkpoint-wf -T 2020-07-20T21:22:10+00:00 -k 60 -K 30 ./print_nums1_py 
job_ec=$?
