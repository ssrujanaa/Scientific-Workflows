...
pegasus-kickstart  -n Thumbs_up -N ID0000001 -R condorpool  -s output.txt=output.txt -L add_thumbs -T 2020-07-16T01:09:06+00:00 /usr/bin/add_thumbs_up.py input.txt output.txt
set -e
EOF2
